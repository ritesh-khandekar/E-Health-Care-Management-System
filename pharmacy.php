...
<head>
    ...
    <title>Pharmacy E-HEALTH-CARE MANAGEMENT SYSTEM</title>
...
<body class="pt-4">
    ...
    <main class="container p-2 pt-4 mt-4">
      <div class="d-none">
        ...
        <div class="h3 text-primary m-4">Available Medicines:</div>
  ...
  <div class = "w-100">
    ...
    <button class= "btn btn-success float-right" id="gotocart">Go to Cart</button>
  </div>
    </main>
      ...
      <script>
        ...
        $("#addtocartbtn").click(function(){
          ...
          $("table tbody tr td input").each(function(){
            if(parseInt($(this).val()) > 0){
              let medjson = {dataid : $(this).parent().prev().attr("data-id"),quantity:parseInt($(this).val())};
