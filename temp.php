...
<section data-silex-type="container-element" class="container-element editable-style silex-id-1478366444112-1 section-element prevent-resizable" data-silex-id="silex-id-1478366444112-1" style="">
         <div data-silex-type="container-element" class="editable-style silex-element-content silex-id-1478366444112-0 container-element website-width" data-silex-id="silex-id-1478366444112-0" style="">
            ...
            <div data-silex-type="text-element" class="editable-style silex-id-1552765147494-1 text-element silex-component prevent-resizable hide-on-desktop hamburger-menu prevent-auto-z-index" data-silex-id="silex-id-1552765147494-1">
               <div class="silex-element-content normal"><style>.hamburger-menu_1635416358495_531 {position: absolute; z-index: 20;}.silex-editor .hamburger-menu_1635416358495_531 nav {left: -9999px;}.hamburger-menu_1635416358495_531 nav ul {margin-top: 80px;}.hamburger-menu_1635416358495_531 nav {opacity: 0; position: absolute; background-color: #ededed; transition: left 1s ease, height 0s ease 1s; left: -300px; width: 300px; height: 20px;}.hamburger-menu_1635416358495_531.open nav {opacity: 1; height: 100vh; left: 0; transition: left 1s ease, height 0s ease 0s;}.hamburger-menu_1635416358495_531 .nav-container {z-index: 10; position: absolute;}.hamburger-menu_1635416358495_531.open .nav-container {}.hamburger-menu_1635416358495_531 .hamburger-btn {z-index: 20; cursor: pointer; position: absolute;}.hamburger-menu_1635416358495_531 .hamburger-btn span {display: block; width: 30px; height: 5px; margin-bottom: 3px; position: relative; background-color: #000000; border: 1px solid #ffffff; border-radius: 3px; transition: border-color 0.1s ease-in,
      opacity 0.1s ease-in,
      transform 0.1s ease-in,
      background 0.1s ease-in;}.hamburger-menu_1635416358495_531.open .hamburger-btn span {border-color: rgba(255, 255, 255, 0);}.hamburger-menu_1635416358495_531 .hamburger-btn span:first-child {transform-origin: 4px -2px;}.hamburger-menu_1635416358495_531.open .hamburger-btn span:first-child {transform: rotate(45deg) translate(7px, -4px);}.hamburger-menu_1635416358495_531.open .hamburger-btn span:nth-last-child(2) {opacity: 0;}.hamburger-menu_1635416358495_531 .hamburger-btn span:nth-child(3) {transform-origin: -11px 4px;}.hamburger-menu_1635416358495_531.open .hamburger-btn span:nth-child(3) {transform: rotate(-45deg) translate(0, 12px);}</style>
<!-- inspired by https://codepen.io/erikterwan/pen/EVzeRP -->
<div class="hamburger-menu_1635416358495_531 closed">
      ...
      <div class="prevent-scale">
        <nav role="navigation" class="">
            <ul>
                ...
                <li><a href="#!page-vacations">Vacations</a></li>
            
                <li><a href="#!page-flights">Flights</a></li>
...
(function() {
  ...
  function close() {
    isOpen = false;
    $('.hamburger-menu_1635416358495_531').removeClass('open');
    $('.hamburger-menu_1635416358495_531').addClass('closed');
  }
  function open() {
    isOpen = true;
    $('.hamburger-menu_1635416358495_531').addClass('open');
    $('.hamburger-menu_1635416358495_531').removeClass('closed');
  }
  function toggle() {
    if(isOpen) close();
    else open();
  }
  var silexElement = $('.hamburger-menu_1635416358495_531').closest('.editable-style');
  function move(data) {
    var offset = silexElement.offset();
    $('.hamburger-menu_1635416358495_531 .nav-container').css({
      'transform': 'translate(' + (data.scrollLeft - (offset.left/data.scale)) + 'px, ' + (data.scrollTop - (offset.top/data.scale)) + 'px)'
    });
  }
  $('.hamburger-menu_1635416358495_531 .hamburger-btn').click(function() { toggle(); });
...
<!--?php endif  ?-->
      ...
      </section><section data-silex-type="container-element" class="container-element editable-style silex-id-1545056415237-3 section-element prevent-resizable page-contact paged-element" data-silex-id="silex-id-1545056415237-3">
         <div data-silex-type="container-element" class="editable-style silex-id-1545056415233-2 container-element silex-element-content website-width" data-silex-id="silex-id-1545056415233-2">
            <div data-silex-type="text-element" class="editable-style text-element text-style-2 silex-id-1545056530213-6" data-silex-id="silex-id-1545056530213-6" style="">
               <div class="silex-element-content normal">
                  <h2>Contact Us<br></h2>
               </div>
               ﻿﻿
            </div>
            <div data-silex-type="html-element" class="editable-style silex-id-1548870370847-0 html-element silex-component silex-component-map silex-use-height-not-minheight silex-element-content-full-height" data-silex-id="silex-id-1548870370847-0">
               <div class="silex-element-content"><div id="mapdiv_1635416358537_700" class="map"><div class="ol-viewport" style="position: relative; overflow: hidden; width: 100%; height: 100%;"><div class="ol-unselectable ol-layers" style="position: absolute; width: 100%; height: 100%; z-index: 0; display: none;"></div><div class="ol-overlaycontainer" style="position: absolute; z-index: 0; width: 100%; height: 100%;"></div><div class="ol-overlaycontainer-stopevent" style="position: absolute; z-index: 0; width: 100%; height: 100%;"><div class="ol-zoom ol-unselectable ol-control"><button class="ol-zoom-in" type="button" title="Zoom in">+</button><button class="ol-zoom-out" type="button" title="Zoom out">−</button></div><div class="ol-rotate ol-unselectable ol-control ol-hidden"><button class="ol-rotate-reset" type="button" title="Reset rotation"><span class="ol-compass">⇧</span></button></div><div class="ol-attribution ol-unselectable ol-control ol-collapsed" style="display: none;"><ul></ul><button type="button" title="Attributions"><span>i</span></button></div></div></div></div>
<style>#mapdiv_1635416358537_700 {width: 100%; height: 100%;}</style>
<script>


function init_1635416358537_700() {
    if(typeof(ol) === 'undefined') {
        // console.warn('Map not ready, restart later')
        // wait for dependencies to be loaded
        setTimeout(init_1635416358537_700, 1000);
        return;
    }

    // empty the div before adding the map again
    $('#mapdiv_1635416358537_700').empty();
    ...
    if(params) {
        ...
        var map = new ol.Map({
          ...
          target: 'mapdiv_1635416358537_700',
          view: new ol.View({
            center: center,
            zoom: zoom
          })
...
// });
            ...
            <div data-silex-type="html-element" class="editable-style silex-id-1548871340538-0 html-element silex-component silex-component-form silex-use-height-not-minheight silex-element-content-full-height" data-silex-id="silex-id-1548871340538-0">
               <div class="silex-element-content"><form id="id_1635416358543_675" action="https://formspree.io/your@email.com" method="POST">
...
<style>#id_1635416358543_675 input[type=text], select {width: 100%; padding: 12px 20px; margin: 8px 0; display: inline-block; border: 1px solid #ccc; border-radius: 3px; box-sizing: border-box;}#id_1635416358543_675 input[type=submit] {width: 100%; background-color: #F78536; color: #FFFFFF; padding: 14px 20px; margin: 8px 0; border: 1px solid; border-radius: 3px; cursor: pointer;}#id_1635416358543_675 label {color: #000000;}#id_1635416358543_675 .fill-vertical {flex: 1 1 auto; display: flex; flex-direction: column;}#id_1635416358543_675 .fill-vertical textarea {flex: 1 1 auto; width: 100%; height: 150px; padding: 12px 20px; box-sizing: border-box; border: 2px solid #ccc; border-radius: 3px; background-color: #f8f8f8; font-size: 16px; resize: none;}#id_1635416358543_675 {border-radius: 3px; display: flex; flex-direction: column; justify-content: space-between; height: 100%;}</style>

</div>
            </div>
         </div>
      </section><section data-silex-type="container-element" class="container-element editable-style silex-id-1545056569614-8 section-element prevent-resizable page-vacations paged-element" data-silex-id="silex-id-1545056569614-8">
         <div data-silex-type="container-element" class="editable-style silex-id-1545056569608-7 container-element silex-element-content website-width" data-silex-id="silex-id-1545056569608-7">
            <div data-silex-type="text-element" class="editable-style text-element text-style-2 silex-id-1545056587321-9" data-silex-id="silex-id-1545056587321-9" style="">
               <div class="silex-element-content normal">
      ...
      </section><section data-silex-type="container-element" class="container-element editable-style section-element silex-id-1545056612457-10 prevent-resizable page-flights paged-element" data-silex-id="silex-id-1545056612457-10">
         <div data-silex-type="container-element" class="editable-style container-element silex-element-content website-width silex-id-1545056612458-11" data-silex-id="silex-id-1545056612458-11">
            <div data-silex-type="text-element" class="editable-style text-element text-style-2 silex-id-1545056612459-12" data-silex-id="silex-id-1545056612459-12" style="">
               <div class="silex-element-content normal">
                  <h2>Your content Here<br></h2>
               </div>
               ﻿﻿
      ...
      </section><section data-silex-type="container-element" class="container-element editable-style section-element silex-id-1545056615878-13 prevent-resizable page-hotels paged-element" data-silex-id="silex-id-1545056615878-13">
