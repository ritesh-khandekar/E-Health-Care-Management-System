<?php
require("methods.php");
if(!isset($_SESSION["hms_medicines"])){header("location: pharmacy.html");}
...
<body class="pt-4">
    ...
    <div class="card px-4">
        ...
        <div class="row gx-3">
            ...
            <div class="col-12">
                <div class="btn btn-primary mb-3" id="paybtn"> <span class="ps-3"><b>Pay ₹<?=$price?> </b></span> <span class="fas fa-arrow-right"></span> </div>
            </div>
            <?php
      ...
      <script>
          $("#paybtn").click(function(){
            ...
            function gateway(){
                ...
                window.open('./appointment/gateway.html','_blank');
            }
