...
<body class="pt-4">
    ...
    <main class="container p-2 pt-4 mt-4">
        <div class="h3 text-primary py-2">All Appointments:</div>
        <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
                ...
                $q = "SELECT users.*,appointments.* FROM appointments INNER JOIN users ON appointments.`patientid` = users.`id` WHERE appointments.`doc-id`='$docid' ORDER BY appointments.count DESC";
                $q = $con->query($q);
