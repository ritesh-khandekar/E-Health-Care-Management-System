              ...
              <div class="form-body">
                <div class="row form-row">
                  <select class="form-control disabled" disabled>
                    <option>Dr. <?= $doctor["name"] . ' ' . $doctor["lname"] ?></option>
                  </select>
                </div>
                <div class="row form-row">
                ...
                <div class="row form-row">
                  <input id="dat" name="date" autocomplete="off" type="text" placeholder="Appointment Date" pattern="[01][0-9]\/[0123][0-9]\/2022" class="form-control" required>
